...
add wave -noupdate -expand -group CIF1 -expand -group Dcache /system_tb/DUT/CPU/CM1/DCACHE/frame_right
...
WaveRestoreCursors {{Cursor 1} {500599 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1018762 ps}

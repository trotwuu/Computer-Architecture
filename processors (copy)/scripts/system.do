...
add wave -noupdate -expand -group Core0 -color Cyan -label IFID /system_tb/DUT/CPU/DP0/II/ifidif/imem_load_o
add wave -noupdate -expand -group Core0 -color Cyan -label IDEX /system_tb/DUT/CPU/DP0/IE/idexif/instr_o
add wave -noupdate -expand -group Core0 -color Cyan -label EXMEM /system_tb/DUT/CPU/DP0/EM/exmemif/instr_o
add wave -noupdate -expand -group Core0 -color Cyan -label MEMWB /system_tb/DUT/CPU/DP0/MW/memwbif/instr_o
add wave -noupdate -expand -group Core1 -color Cyan -label IFID /system_tb/DUT/CPU/DP1/ifidif/imem_load_o
add wave -noupdate -expand -group Core1 -color Cyan -label IDEX /system_tb/DUT/CPU/DP1/idexif/instr_o
add wave -noupdate -expand -group Core1 -color Cyan -label EXMEM /system_tb/DUT/CPU/DP1/exmemif/instr_o
add wave -noupdate -expand -group Core1 -color Cyan -label MEMWB /system_tb/DUT/CPU/DP1/memwbif/instr_o
...
add wave -noupdate -expand -group DP0 -group imem /system_tb/DUT/CPU/DP0/dcif/ihit
add wave -noupdate -expand -group DP0 -group imem /system_tb/DUT/CPU/DP0/dcif/imemaddr
add wave -noupdate -expand -group DP0 -group imem /system_tb/DUT/CPU/DP0/dcif/imemload
add wave -noupdate -expand -group DP0 -group imem /system_tb/DUT/CPU/DP0/dcif/imemREN
add wave -noupdate -expand -group DC0_link /system_tb/DUT/CPU/CM0/DCACHE/state
add wave -noupdate -expand -group DC0_link {/system_tb/DUT/CPU/CM0/DCACHE/frame_right[0]}
add wave -noupdate -expand -group DC0_link {/system_tb/DUT/CPU/CM0/DCACHE/frame_left[4]}
add wave -noupdate -expand -group DC0_link {/system_tb/DUT/CPU/DP0/RF/registers[8]}
add wave -noupdate -expand -group DC0_link /system_tb/DUT/CPU/CM0/DCACHE/linkreg
add wave -noupdate -expand -group DC0_link /system_tb/DUT/CPU/CM0/DCACHE/linkval
...
add wave -noupdate -group DP1 -group imem /system_tb/DUT/CPU/DP1/dcif/ihit
add wave -noupdate -group DP1 -group imem /system_tb/DUT/CPU/DP1/dcif/imemaddr
add wave -noupdate -group DP1 -group imem /system_tb/DUT/CPU/DP1/dcif/imemload
add wave -noupdate -group DP1 -group imem /system_tb/DUT/CPU/DP1/dcif/imemREN
add wave -noupdate -expand -group DC1_link /system_tb/DUT/CPU/CM1/DCACHE/state
add wave -noupdate -expand -group DC1_link {/system_tb/DUT/CPU/CM1/DCACHE/frame_right[0]}
add wave -noupdate -expand -group DC1_link {/system_tb/DUT/CPU/CM1/DCACHE/frame_left[4]}
add wave -noupdate -expand -group DC1_link {/system_tb/DUT/CPU/DP1/RF/registers[8]}
add wave -noupdate -expand -group DC1_link /system_tb/DUT/CPU/CM1/DCACHE/linkreg
add wave -noupdate -expand -group DC1_link /system_tb/DUT/CPU/CM1/DCACHE/linkval
...
add wave -noupdate -expand -group CIF0 -expand -group Dcache -radix hexadecimal /system_tb/DUT/CPU/CM0/DCACHE/addr
add wave -noupdate -expand -group CIF0 -expand -group Dcache /system_tb/DUT/CPU/CM0/DCACHE/addr
...
add wave -noupdate -expand -group CIF0 -expand -group Dcache -expand /system_tb/DUT/CPU/CM0/DCACHE/frame_right
...
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/nxt_hit_count
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/hit_count
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/nxt_LRU
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/nRST
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/LRU
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/nxt_miss
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/miss
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/nxt_row_count
add wave -noupdate -expand -group CIF0 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM0/DCACHE/row_count
...
add wave -noupdate -expand -group CIF1 -expand -group Dcache -radix hexadecimal /system_tb/DUT/CPU/CM1/DCACHE/addr
...
add wave -noupdate -expand -group CIF1 -expand -group Dcache {/system_tb/DUT/CPU/CM1/DCACHE/frame_right[1]}
...
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/hit_count
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/LRU
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/miss
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/nxt_hit_count
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/nxt_LRU
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/nxt_miss
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/nxt_row_count
add wave -noupdate -expand -group CIF1 -expand -group Dcache -group notimportant /system_tb/DUT/CPU/CM1/DCACHE/row_count
...
add wave -noupdate -group {Core0 RFIF} -expand /system_tb/DUT/CPU/DP0/RF/registers
...
add wave -noupdate -group {Core1 RFIF} -expand /system_tb/DUT/CPU/DP1/RF/registers
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {9295090 ps} 0}
...
update
WaveRestoreZoom {8971604 ps} {9908397 ps}
